...
(function(root){
  ...
  function injectCSS(){
    ...
    s.textContent=[
      ...
      '.gt-teams{display:flex;gap:8px}',
      '.gt-team{flex:1;display:flex;flex-direction:column;gap:6px}',
      '.gt-team-l{font-size:10px;font-weight:700;letter-spacing:.06em;text-align:center;opacity:.7}',
