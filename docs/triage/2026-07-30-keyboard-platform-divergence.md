...
- **动到的文件**：`js/keyboard.js`、必要时 `index.html` 的聊天 `.stage` 回退规则
- **动到的模块/函数**：主聊天键盘 IIFE 的 `updateChatLayout`、focusin/focusout、VisualViewport 监听；不动弹窗输入框滚动逻辑
