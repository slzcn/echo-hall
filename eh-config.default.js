...
(function(root){
  ...
  const THEME_PALETTES = {
    ...
    aurora: {
      ...
      '--ink':'#E6FBF6', '--sub':'#9BD4CC', '--dim':'#5A8A84',
      '--cyan':'#2EF0C8', '--magenta':'#5AD1FF', '--violet':'#7CE0B0',
      '--amber':'#8CE6D0', '--green':'#3EE89A',
      '--grid':'rgba(80,220,255,.05)',
      '--glow-cyan':'0 0 26px rgba(46,240,200,.55)',
      '--glow-mag':'0 0 24px rgba(90,209,255,.5)',
    },
  };
