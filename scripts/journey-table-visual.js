...
assert(/BUILD_VER='20260819-lobby-bind-tdz'/.test(HTML), 'index.html BUILD_VER=20260819-lobby-bind-tdz');
assert(/eh-sw-v333-20260819-lobby-bind-tdz/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v333-lobby-bind-tdz)');
assert(/^20260819-lobby-bind-tdz\s*$/.test(R('ver.txt')), 'ver.txt=20260819-lobby-bind-tdz');
