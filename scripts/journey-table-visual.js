...
assert(/BUILD_VER='20260819-refresh-perf'/.test(HTML), 'index.html BUILD_VER=20260819-refresh-perf');
assert(/eh-sw-v344-20260819-refresh-perf/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v344-refresh-perf)');
assert(/^20260819-refresh-perf\s*$/.test(R('ver.txt')), 'ver.txt=20260819-refresh-perf');
