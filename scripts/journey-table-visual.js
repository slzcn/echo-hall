...
assert(/BUILD_VER='20260819-settle-parity'/.test(HTML), 'index.html BUILD_VER=20260819-settle-parity');
assert(/eh-sw-v334-20260819-settle-parity/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v334-settle-parity)');
assert(/^20260819-settle-parity\s*$/.test(R('ver.txt')), 'ver.txt=20260819-settle-parity');
