...
assert(/BUILD_VER='20260819-btn-steady'/.test(HTML), 'index.html BUILD_VER=20260819-btn-steady');
assert(/eh-sw-v342-20260819-btn-steady/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v342-btn-steady)');
assert(/^20260819-btn-steady\s*$/.test(R('ver.txt')), 'ver.txt=20260819-btn-steady');
