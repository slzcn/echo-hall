...
assert(/BUILD_VER='20260819-fly-dir'/.test(HTML), 'index.html BUILD_VER=20260819-fly-dir');
assert(/eh-sw-v339-20260819-fly-dir/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v339-fly-dir)');
assert(/^20260819-fly-dir\s*$/.test(R('ver.txt')), 'ver.txt=20260819-fly-dir');
