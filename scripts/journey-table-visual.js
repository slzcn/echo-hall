...
assert(/BUILD_VER='20260819-open-reap'/.test(HTML), 'index.html BUILD_VER=20260819-open-reap');
assert(/eh-sw-v343-20260819-open-reap/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v343-open-reap)');
assert(/^20260819-open-reap\s*$/.test(R('ver.txt')), 'ver.txt=20260819-open-reap');
