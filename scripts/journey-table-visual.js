...
assert(/BUILD_VER='20260819-flop-stagger'/.test(HTML), 'index.html BUILD_VER=20260819-flop-stagger');
assert(/eh-sw-v338-20260819-flop-stagger/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v338-flop-stagger)');
assert(/^20260819-flop-stagger\s*$/.test(R('ver.txt')), 'ver.txt=20260819-flop-stagger');
