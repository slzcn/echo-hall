...
assert(/BUILD_VER='20260819-soul-fill'/.test(HTML), 'index.html BUILD_VER=20260819-soul-fill');
assert(/eh-sw-v341-20260819-soul-fill/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v341-soul-fill)');
assert(/^20260819-soul-fill\s*$/.test(R('ver.txt')), 'ver.txt=20260819-soul-fill');
