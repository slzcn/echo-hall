...
assert(/BUILD_VER='20260819-seat-guard'/.test(HTML), 'index.html BUILD_VER=20260819-seat-guard');
assert(/eh-sw-v335-20260819-seat-guard/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v335-seat-guard)');
assert(/^20260819-seat-guard\s*$/.test(R('ver.txt')), 'ver.txt=20260819-seat-guard');
