...
assert(/BUILD_VER='20260820-fold-ime-coord'/.test(HTML), 'index.html BUILD_VER=20260820-fold-ime-coord');
assert(/eh-sw-v345-20260820-fold-ime-coord/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v345-fold-ime-coord)');
assert(/^20260820-fold-ime-coord\s*$/.test(R('ver.txt')), 'ver.txt=20260820-fold-ime-coord');
