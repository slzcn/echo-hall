...
assert(/BUILD_VER='20260819-guandan-rows'/.test(HTML), 'index.html BUILD_VER=20260819-guandan-rows');
assert(/eh-sw-v332-20260819-guandan-rows/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v332-guandan-rows)');
assert(/^20260819-guandan-rows\s*$/.test(R('ver.txt')), 'ver.txt=20260819-guandan-rows');
