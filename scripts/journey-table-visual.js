...
assert(/BUILD_VER='20260819-soul-coop'/.test(HTML), 'index.html BUILD_VER=20260819-soul-coop');
assert(/eh-sw-v340-20260819-soul-coop/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v340-soul-coop)');
assert(/^20260819-soul-coop\s*$/.test(R('ver.txt')), 'ver.txt=20260819-soul-coop');
