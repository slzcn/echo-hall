...
assert(/BUILD_VER='20260820-tex-loose'/.test(HTML), 'index.html BUILD_VER=20260820-tex-loose');
assert(/eh-sw-v346-20260820-tex-loose/.test(R('sw.js')), 'sw.js SW_VERSION 含 BUILD_VER(升 v346-tex-loose)');
assert(/^20260820-tex-loose\s*$/.test(R('ver.txt')), 'ver.txt=20260820-tex-loose');
